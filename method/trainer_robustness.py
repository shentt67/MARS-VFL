...
from method.robustness.AugVFL import augvfl
from method.Base import base
from method.robustness.LEEFVFL import leefvfl, valid_leefvfl, test_leefvfl
from method.robustness.RealVFL import realvfl, valid_realvfl, test_realvfl
...
class Trainer_Robustness:
                ...
                if self.args.perturb_type == 'missing':
                    ...
                    if self.args.method_name == 'leefvfl':
                        ...
                        if eval_results_list == -1:
                            continue
                if self.args.method_name in ['base', 'augvfl', 'realvfl']:
    ...
    def valid(self, ep):
        ...
        elif self.args.method_name == 'realvfl':
            return valid_realvfl(self, ep)
    ...
    def test(self, ep):
        ...
        if self.args.method_name == 'realvfl':
            return test_realvfl(self, ep)

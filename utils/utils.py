...
def parser_add(parser):
    ...
    parser.add_argument('--data_dir', default='/data0/sw_data/data/VFLBench/', help='data directory')
    ...
    parser.add_argument('--results_dir', default='/data1/chenmingde/data/vfl_benchmark_log/logs/' + str(currentDateAndTime),
